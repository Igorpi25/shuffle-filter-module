Vue.component('shuffle-not', {
    ...
    props: ['id'],
    template: `
    <div @focus="onFocus" tabindex="-1" :title="id" class="flex flex-col p-1 items-center bg-red-100 outline-indigo-600 outline-1 hover:outline-dashed focus:outline focus:outline-2">
